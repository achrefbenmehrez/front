...
@Component({
  selector: 'app-reclamations-traites',
  templateUrl: './reclamations-traites.component.html',
  styleUrls: ['./reclamations-traites.component.scss']
})
export class ReclamationsTraitesComponent {
  ...
  private getTableData(pageOption: pageSelection = { skip: 0, limit: 10 }): void {
    ...
    if (token) {
      ...
      this.http.get('http://localhost:8089/api/reclamations/traités', { headers }).subscribe(
        (data: any) => {
