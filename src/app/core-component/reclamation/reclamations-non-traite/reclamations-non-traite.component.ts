...
@Component({
  selector: 'app-reclamations-non-traite',
  templateUrl: './reclamations-non-traite.component.html',
  styleUrls: ['./reclamations-non-traite.component.scss']
})
export class ReclamationsNonTraiteComponent {
  ...
  private getTableData(pageOption: pageSelection = { skip: 0, limit: 10 }): void {
    ...
    if (token) {
      ...
      this.http.get('http://localhost:8089/api/reclamations/non-traités', { headers }).subscribe(
        (data: any) => {
